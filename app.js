...
if (window.history && window.history.pushState) {
  ...
  // Обработчик нажатия кнопки изменения имени пользователя
  function changeUsername() {
    const newDisplayName = prompt('Введите новое имя пользователя:');
...
// Обработчик нажатия на имя пользователя для изменения
